...
task = f"Develop a business marketing summary for {business_name} (product or service) in industry vertical {industry}. The Founer will outline the idea initially"
...
The Founder must instruct you based on your expertise and my needs to complete the task.
...
Always end <YOUR_SOLUTION> with: Next question is."""
)
...
Here is the task: {task}. Never forget our task!
You must ask direct questions about your business and your needs to complete the task ONLY in the following two ways:
...
The "Instruction" describes a task or question. The paired "Input" provides further context or information for the requested "Instruction". It is a response from the agent.
...
while n < chat_turn_limit:
    ...
    if "<CAMEL_TASK_DONE>" in user_msg.content:
        ...
        while n < 4:
            ...
            assistant_msg = HumanMessage(content=assistant_ai_msg.content)
            assistant_ai_msg = assistant_agent.step(user_msg)
            assistant_msg = HumanMessage(content='''Summarize the chat, the business and write a report which outlines the business, it's competitive advantage 
                                         and likely product market fit then write <CAMEL_TASK_DONE> to end the chat.''')
            #Save to file
            if "<CAMEL_TASK_DONE>" in user_msg.content:
